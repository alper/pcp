...
impl RobotScheduling {
    ...
    fn start_at(&self, robot: usize, task: usize) -> isize {
        self.start[robot * TASKS + task]
            .read(&self.space.vstore)
            .lower()
    }

    fn duration_at(&self, robot: usize, task: usize) -> isize {
        self.duration[robot * DTASKS + task]
            .read(&self.space.vstore)
            .lower()
    }
}
